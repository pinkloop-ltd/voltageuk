                    ...
                    <form action="{{ route('users.store') }}" method="post">
                      ...
                      <div class="form-row">
                        <div class="form-group">
                          ...
                          <input value="{{ $user->name }}" type="name" name="name" class="form-control" id="name"/>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input value="{{ $user->initials }}" type="string" name="initials" class="form-control" id="initials"/>
                        </div>
                      </div>
